...
export default function FooterSubscribe({className = ""}) {
    ...
    return (
        ...
        <div className={`${styles.footerCol} ${styles.footerSub} ${className ? className : undefined}`}>
            ...
            <form className={`form ${styles.subscribeForm}`} action="#" method="post">
                ...
                <fieldset className={`formItem fullWidth ${styles.footerFormItem}`}>
                    ...
                    <input type="text" name="name" id="name" placeholder="Enter your name" required autoComplete="name" />
                ...
                <div className={`formFooter`}>
                    ...
                    <button type="submit" className={`btn ${styles.footerFormButton}`}>Subscribe</button>
