  ...
  return (
    <>
      <form onSubmit={onSubmit} className="form contactForm">
        ...
        <fieldset
          className="formItem consent fullWidth"
          onClick={() => isChecked(!checked)}
        >
          <div className="consentInput">
            <input type="checkbox" name="consent" required />

            <span style={{ display: checked ? "block" : "none" }}>
              <Checkmark size={14} color="var(--primary)" />
            </span>
          </div>
      ...
      <div
        className="formMessage container centered"
        aria-live="polite"
        aria-atomic="true"
        style={{
          display: result === "Form Submitted Successfully" ? "flex" : "none",
        }}
      >
