...
// Icons
import { ArrowUpRight, Checkmark } from "@carbon/react/icons";
import Link from "next/link";
// Next
import { useState } from "react";

export default function ContactForm({ data = "New Contact Form Submission", hasEnquiryType = true, hasCompanyName = true, hasUrlField = false }) {
      ...
      <form onSubmit={onSubmit} className="form contactForm">
        ...
        {hasEnquiryType && (
          ...
          <fieldset className="formItem dropdown">
            ...
            <select name="service" required>
              ...
              <option value="design">Careers</option>
              <option value="design">Support</option>
        ...
        {hasUrlField && (
          ...
          <fieldset className="formItem fullWidth">
            ...
            <input type="url" name="url" placeholder="Link to CV*" required />
