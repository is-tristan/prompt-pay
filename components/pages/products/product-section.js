...
export default function ProductSection({
  ...
  return (
    <section
      className={`row ${styles.productSection} ${rowClassName ? styles[rowClassName] : undefined}`}
    >
      <div
        className={`container dualCols ${styles.productSectionContainer} ${containerClassName ? containerClassName : undefined} `}
      >
          ...
          {image && (
            <>
              ...
              {rowClassName === "productHeader" && (
                <Image
                  src={
                    productCategory === "clover"
                      ? cloverLogo
                      : productCategory === "worldpay"
                        ? worldPayLogo
                        : null
                  }
                  alt={
        ...
        <div className={`col contentCol ${styles.contentCol}`}>
          ...
          {listItems.length > 0 && <CheckList items={listItems} />}
