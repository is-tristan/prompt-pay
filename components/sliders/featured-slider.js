...
export default function FeatureSlider() {
    ...
    return (
        ...
        <div className="sliderWrapper featureSliderWrapper">
            ...
            <Splide ref={splideRef} options={options} aria-label="Feature Slider" className={`splideSlider featureSlider`}>

                {cloverSlides.map((slide) => (

                    <SplideSlide key={slide.id}>

                        <article className="featureSliderCard" style={{ backgroundImage: `url(${slide.image})` }}>
                            ...
                            <div className="featureSliderContent">
                                ...
                                <Buttons btnOneText={slide.linkLabel} btnOneLink={slide.link} btnOneClass="textLink" />
